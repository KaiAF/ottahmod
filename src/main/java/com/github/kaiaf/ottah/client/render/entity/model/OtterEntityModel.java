...
//    private final ModelPart tail_r1;
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData tail_r1 = body.addChild("tail_r1", ModelPartBuilder.create().uv(9, 21).cuboid(-2.0F, -0.55F, -4.6F, 3.0F, 3.0F, 8.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -5.0F, 11.0F, -0.3491F, 0.0F, 0.0F));
