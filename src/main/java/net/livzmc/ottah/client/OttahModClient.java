...
public class OttahModClient implements ClientModInitializer {
    public static final ModelLayerLocation OTTER = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(OttahMod.MOD_ID, "otter"), "main");
    public static final ModelLayerLocation OTTER_LEASHED = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(OttahMod.MOD_ID, "otter_leashed"), "main");
